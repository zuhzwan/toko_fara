...
?>
        		<!--<div class="span4">-->
                    ...
                    <table>
                    <tr>
                        <td rowspan="7" width="300"><img src="<?php echo $data['br_gbr']; ?>" /></td>
                        </tr>
                        <tr>
					...
					<!--	<p>
                        ...
                        <td></td>
                        <td></td>
						<td><div class="clear"> <a href="index.php?add=<?php echo $data['br_id'];?>" class="btn btn-lg btn-danger">Beli &raquo;</a></div></td>
                        </tr>
