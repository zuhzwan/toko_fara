              ...
              <div class="panel-body">
                 <div class="table-responsive">
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    { ?>
                    <tr>
                    <td><? echo $data['kode_kar']; ?></td>
                    <td><a href="gaji.php?hal=edit&kd=<?php echo $data['kary_id'];?>"><i class="fa fa-user"></i> <? echo $data[nama_kar]; ?></a></td>
                    <td><? echo $data[alamat_kar]; ?></td>
                    <td><? echo $data[no_rek]; ?></td>
                    <td>Rp.<?php echo number_format($data['gaji_utama'],2,",",".");?></td>
                    <td><? echo $data[gol_kar];?></td>
