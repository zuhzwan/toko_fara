...
if (empty($_SESSION['username'])){
	echo "<script>alert('Anda belum mempunyai hak akses.'); window.location = '../index.php'</script>";	
} else {
	include "../koneksi.php";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <meta name="description" content="DistroIT">
    <meta name="author" content="Hakko Bio Richard">

    <title>DistroIT | Toko Online terlengkap dan terpercaya di cikarang</title>
...
<?php } ?>
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h1>Dashboard <small>DistroIT</small></h1>
            <ol class="breadcrumb">
...
<!--
        ...
        <div class="col-lg-12">
            <div class="panel panel-primary">
              <div class="panel-heading">
                <h3 class="panel-title"><i class="fa fa-user"></i> Tambah Data Barang </h3>
              </div>
              <div class="panel-body">
    ...
    <tr>
        <td><label for="br_id">Kode Barang</label></td>
        <td><input name="br_id" type="text" class="form-control" id="br_id" placeholder="Kode Barang" required/></td>
      </tr>
      <tr>
        <td><label for="br_nm">Nama Barang</label></td>
        <td><input name="br_nm" type="text" class="form-control" id="kode_kar" placeholder="Nama Barang" required/></td>
      </tr>
      <tr>
        <td><label for="br_item">Item</label></td>
        <td><input name="br_item" type="text" class="form-control" id="br_item" placeholder="Item Barang" required/></td>
      </tr>
      <tr>
        <td><label for="br_hrg">Harga</label></td>
        <td><input name="br_hrg" type="text" class="form-control" id="br_hrg" placeholder="Harga barang" required/></td>
      </tr>
      <tr>
        <td><label for="br_stok">Stok</label></td>
        <td><input name="br_stok" type="text" class="form-control" id="br_stok" placeholder="Stok" required/></td>
      </tr>
      <tr>
        <td><label for="br_satuan">Satuan</label></td>
        <td><input name="br_satuan" type="text" class="form-control" id="br_satuan" placeholder="Satuan" required/></td>
      </tr>
      <tr>
        <td><label for="br_gbr">Gambar</label></td>
        <td><input name="br_gbr" type="text" class="form-control" id="br_gbr" placeholder="gambar/file.jpg" required/></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><label for="br_sts">Status</label></td>
        <td><input name="br_sts" type="text" class="form-control" id="br_sts" placeholder="Status Barang" required/></td>
      </tr>
      <tr>
