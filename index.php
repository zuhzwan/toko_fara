...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Kerudung Rabbani <br><br>Grand Karimun</h2>
				
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/kaos.jpg" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Kerudung Rabbani <br><br>Venta</h2>
				
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/jaket5.jpg" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>Kerudung Rabbani <br><br>Zahira Solder Anyar</h2>
				
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/jeans.jpg" alt="image03" /></div>
			</div>
			<div class="da-slide">
				<h2>Kerudung Rabbani <br></br>Grand Navara Poly</h2>
				
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/jpg.jpg" alt="image04" /></div>
			</div>
		...
		while($data = mysql_fetch_assoc($sql)){
        		...
        		<div class="span4">
					...
					<!--	<p>
						...
						<div class="clear"><a href="detailproduk.php?kd=<?php echo $data['br_id'];?>" class="btn btn-lg btn-danger">Detail</a> <a href="index.php?add=<?php echo $data['br_id'];?>" class="btn btn-lg btn-success">Beli &raquo;</a></div>
