	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-list ico-white"></i>Daftar Pemesan</h2>
...
<tr>
				...
				$no = 1;
							...
							$get = mysql_query('SELECT * FROM pemesan');
							...
							while($get_row = mysql_fetch_assoc($get)){
								...
								<tr>
									...
									<td align="center">'.$get_row['nm_usr'].'</td>
									<td align="center">'.$get_row['almt_usr'].'</td>
									<td align="right">'.$get_row['kota_usr'].'</td>
									<td align="right">'.$get_row['tlp'].'</td>
								
										<td align="right"> Rp. '.$get_row['total'].'</td>
